...
const Captcha = () => {
    ...
    <p>
    Please enter the correct value as displayed below to continue to your Download
    </p>
    <img
    alt="captcha"
    ...
    <div class="text-center">
        <h1>Atom Plugin Download</h1>
    </div>
    <div class="row justify-content-center">
        <div class="col-md-6">
        <p>Please enter the correct value as displayed below to continue to your Download:</p>
